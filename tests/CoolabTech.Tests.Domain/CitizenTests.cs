...
namespace CoolabTech.Tests.Domain
{
    ...
    public class CitizenTests
    {
        ...
        {
            var citizen = new Citizen(Guid.NewGuid(), "", "ariosmaia", "12345678945", "arios@gmail.com", EGender.Male, DateTime.Now);
        ...
        {
            var citizen = new Citizen(Guid.NewGuid(), "Allan", "ariosmaia", "12345678945", "arios@gmail.com", EGender.Male, DateTime.Now);
        ...
        {
            var citizen = new Citizen(Guid.NewGuid(), "Allan", "", "12345678945", "arios@gmail.com", EGender.Male, DateTime.Now);
            Assert.False(citizen.IsValid());
        }
        ...
        {
            var citizen = new Citizen(Guid.NewGuid(), "Allan", "ariosmaia", "12345", "ariosgmail", EGender.Male, DateTime.Now);
            Assert.False(citizen.IsValid());
        }
        ...
        {
            var citizen = new Citizen(Guid.NewGuid(), "Allan", "ariosmaia", "12345678945", "ariosgmail.com", EGender.Male, DateTime.Now);
            Assert.False(citizen.IsValid());
        }
